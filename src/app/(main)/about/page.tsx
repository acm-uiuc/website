    ...
    <>
      ...
      <div className="flex flex-col gap-8 bg-surface-000 pt-6 pb-24">
        <section id="about" className="container flex flex-col gap-4">
          <h1>About Us</h1>
          <p>
            ACM@UIUC is the <ExtLink href="https://www.acm.org/">Association for Computing Machinery</ExtLink> student 
          ...
          <p>
            ...
            more about each SIG on our <Link href="/" className="text-primary hover:text-secondary transition-all">home page</Link>!
          </p>
          <p>
            ACM@UIUC also runs various events throughout the year, such as ACM Open House, 
            which showcases all the different SIGs at the beginning of each semester, <ExtLink href="https://www.reflectionsprojections.org/">Reflections | Projections</ExtLink>, 
            our annual computing conference, and <ExtLink href="https://hackillinois.org/">HackIllinois</ExtLink>, 
