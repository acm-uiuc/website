...
export const boothDetails: Record<BoothType['id'], IBoothDetails> = {
  ...
  '6' : {
    ...
    links: [
      { text: 'Website', link: 'https://academic.acm.illinois.edu/' },
    ],
    tableId: 17,
  },
  '7' : {
  ...
  '8' : {
    description: 'HackIllinois is UIUC\'s premier collegiate hackathon that brings together students, professionals, and industry leaders to collaborate and innovate.',
    links: [
  ...
  '10' : {
    tableId: 21,
    links: [
      { text: 'Coda', link: 'https://coda.io/d/SIGCHI_dL-hkhRaxQN/Home_suXrh_ME#_lu90Yca6'},
    ],
  },
  '11' : {
    tableId: 34,
  ...
  '15' : {
    tableId: 0,
    links: [
      { text: 'GitHub', link: 'https://github.com/sigmusic'},
    ],
  },
  '16' : {
    name: 'SIGSYS',
    ...
    customLogo: true,
    description: 'Learn about Operating Systems, Netorking, Compilers, Distributed Systems, and more! Featured at the GLUG table.',
    keywords: ["SIG", "systems", "networking", "compilers", "distributed systems"],
    tableId: 19,
  },
  '17' : {
    tableId: 19,
