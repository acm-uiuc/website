  ...
  export const partners: BoothType[] = [
    {
      ...
      customLogo: true,
      description: 'We are a non-profit educational student group under the UIUC Computer Science Department dedicated to supporting the efforts of young women and non-binary people in technology. We host a variety of networking events with our corporate sponsors, technical workshops and discussions, social events for our members and many more!',
      links: [
    ...
    },
    {
      ...
      customLogo: true,
      description: 'B[U]ILT serves to provide opportunities and services for students of the university. The opportunities created are professional, academic, and social aimed at fostering a healthy and comfortable community for underrepresented students interested in tech.',
      links: [
        { text: 'Slack', link: 'https://linktr.ee/built_uiuc' },
      ],
      keywords: ['community', 'support', 'tech'],
      tableId: 28,
    },
    ...
    },
    {
        ...
        customLogo: true,
        description: 'Sail is a free annual 2-day event for HS students to experience CS @ Illinois. Sail 2025 will be March 29 & 30. For current UIUC students, come teach at Sail!',
        links: [
            { text: 'Click Here to Learn More', link: 'https://forms.gle/gZjVrH91T95WUj1w8' },
        ],
    ...
    },
    {
        ...
        customLogo: true,
        description: 'Open Source at Illinois is an organisation that promotes open source development at UIUC through projects and workshops. We have made projects on Github related to Computer Vision, LLMs, Web development, and more. The workshops cover modern-day technologies being used in the industry.',
        links: [
            { text: 'Website', link: 'https://opensourceatillinois.com/' },
        ],
