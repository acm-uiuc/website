      ...
      <div className="flex flex-col md:flex-row bg-surface-000 pt-6 pb-24">
        ...
        <nav className="w-full md:w-72">
          <div className="sticky top-6 flex flex-col items-center mx-auto">
            ...
            <div className="space-y-4">
              ...
              <Link href="#cs-cares" className="block p-4 bg-acmdark hover:bg-secondary text-white rounded-lg shadow-md">
                CS Cares
              </Link>
              <Link href="#feedback" className="block p-4 bg-acmdark hover:bg-secondary text-white rounded-lg shadow-md">
                Feedback
              </Link>
            </div>
          </div>
        ...
        <div className="bg-surface-000 md:w-5/6">
          <section id="acm-paid-member-guide" className="p-6 rounded-lg shadow-md">
            ...
            <ul className="list-disc list-inside">
              ...
              <li>
                ...
                <p>
                  Automatically done! Your discount will be automatically applied at checkout for events such as semi-formal when you use your Illinois email!
                </p>
              </li>
              <li>
                <h5 className="inline font-bold">Discounted Latea</h5>
                <p>
                  ACM is partnering with Latea, so every paid member now has a 10% discount (non-stackable) at Latea! At the counter, show the ACM @ UIUC membership pass in your digital wallet.{' '}
                  You can also go to <ExtLink href="https://membership.acm.illinois.edu">our membership page</ExtLink> and enter your NetID to get confirmation that you are a paid member and enjoy your sweet treat!
                </p>
              </li>
            </ul>
          </section><br /><br />
          ...
          <section id="cs-cares" className="p-6 rounded-lg shadow-md">
            ...
            <p>
              CS CARES is a confidential resource for students to discuss concerns about potential Code of Conduct violations; feel free to ask them for guidance or support in addressing any academic integrity issues inside and outside of ACM. <ExtLink href="https://siebelschool.illinois.edu/about/cs-cares">https://siebelschool.illinois.edu/about/cs-cares</ExtLink>
            </p>
          </section><br /><br />
          ...
          <section id="feedback" className="p-6 rounded-lg shadow-md">
            ...
            <p>
              We value your experience and want to create the most supportive and inclusive community possible. This anonymous <ExtLink href="https://go.acm.illinois.edu/feedback">feedback form</ExtLink> is your opportunity to share your thoughts, concerns, or suggestions about ACM. We take every submission seriously and will ensure confidentiality. Help us create positive changes in our community!
            </p>
          </section>
        </div>
      </div>
