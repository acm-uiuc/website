  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-primary-300 text-white p-6 w-full">
      <header className="flex flex-col items-center mb-6">
        ...
        <h1 className="text-2xl sm:text-4xl font-bold mt-4 text-center text-white">
          {headers[chosenHeader]}
        </h1>
        <p className="mt-4 text-center text-white">
          The page you requested was not found. Would you like to{' '}
      ...
      <div className="w-full max-w-2xl h-80 sm:h-96 p-4 m-4 bg-gray-800 border border-gray-700 text-white overflow-hidden rounded-md">
        <div
          ...
          dangerouslySetInnerHTML={{
            __html: displayedText + (showCursor ? ' _' : ' '),
          }}
        />
      </div>
      <Footer />
