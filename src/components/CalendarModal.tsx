        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative z-10 mx-4 w-full max-w-lg rounded-2xl bg-white p-10 shadow-2xl animate-[popIn_200ms_ease-out]">
            ...
            <div className="mb-6 text-center">
              <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-tangerine-100">
                <svg
                  className="h-6 w-6 text-tangerine-600"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex w-full items-center gap-4 rounded-xl border-2 border-gray-200 p-4 transition-all hover:border-tangerine-500 hover:bg-tangerine-50"
              >
              ...
              >
                ...
                <div className="flex-1 text-left">
                  <h3 className="font-semibold text-navy-900">Apple / iCal</h3>
                  <p className="text-sm text-gray-500">
            ...
            <p className={'text-xs mt-2 text-gray-500 text-center'}>
              ...
              <a
                href={icalUrl}
                className="text-navy-600 border-b-2 border-tangerine-300 transition-all hover:text-navy-800 hover:border-tangerine-500"
              >
                {icalUrl}
              </a>{' '}
