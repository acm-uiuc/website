...
function NavLink({ children, ...rest }: { children: React.ReactNode } & React.HTMLProps<HTMLAnchorElement>) {
  return (
    <a
      ...
      <div className="bg-acmdark text-white text-center p-6">
        <div className="flex flex-col gap-4 items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-x-8 gap-y-4 items-center">
            ...
            <NavLink href="https://www.facebook.com/acmuiuc">
              Facebook
            </NavLink>
            <NavLink href="https://instagram.com/acm.uiuc">
              Instagram
            </NavLink>
            <NavLink href="https://github.com/acm-uiuc">
              GitHub
            </NavLink>
          </div>
        </div>
