...
SIGPwny.args = {
  title: 'SIGPwny',
  description:
    'A friendly but elite club focused on cybersecurity. They host weekly learning meetings and do CTFs and cutting-edge cybersecurity research.',
  links: [
    {
...
SIGAIDA.args = {
  title: 'SIGAIDA',
  description:
    'We are the premier data science organization at the University of Illinois.',
  links: [
    {
