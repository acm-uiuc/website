...
export const OrganizationDataMapping: Record<Organization, IOrgData> = {
  ...
  SIGRobotics: {
    title: 'SIGRobotics',
    description:
      'Learn fundamental robotics skills through hands-on projects, workshops, and speaker events.',
    links: [
      {
  ...
  SIGtricity: {
    title: 'SIGtricity',
    description:
      'Learn about electrical engineering through hands on workshops and projects. Open to all majors and experience levels!',
    links: [
      {
  ...
  ACM: {
    title: 'ACM',
    description:
      'The Association for Computing Machinery at the University of Illinois at Urbana-Champaign.',
    links: [
      {
